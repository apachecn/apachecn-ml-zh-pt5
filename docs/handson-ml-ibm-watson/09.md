...
![](img/ab396f17-1f49-4b85-aa27-166db71fb636.png)<title>Notebook asset type</title>  
...
![](img/01d88983-414f-4ffd-9100-de56f3c23d4d.png)<title>Running the imported notebook</title>  
...
IBM Watson 视觉识别服务带有内置模型，您可以使用这些模型来分析场景、对象、人脸和许多其他类别的图像，而无需任何培训。我们已经创建了视觉识别服务的一个实例，因此它可用于我们的项目。为此，您需要拥有有效的密钥(我们实际的 API 密钥)。
...
![](img/a1874dbc-70a5-4042-b240-6dfb3913ccf3.png)<title>Upgrading Watson</title>  
...
![](img/b7b06b27-feff-47a6-82bc-e7ae5082476b.png)<title>Objects detected</title>  
...
![](img/71d2361b-c83c-4c62-add9-cee100a4e2ac.png)<title>Now the fun part</title>  
...
![](img/11d3605d-8eed-4e7f-af0e-79b35559d38c.png)<title>Save and share your work</title>  
...
![](img/d53062b6-b401-4d3e-ba45-7f0b8e9f37d8.png)<title>Summary</title>  
