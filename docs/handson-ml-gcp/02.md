...
*   **在计算引擎上运行分布式TensorFlow**:[https://cloud . Google . com/solutions/Running-distributed-tensor flow-on-Compute-Engine](https://cloud.google.com/solutions/running-distributed-tensorflow-on-compute-engine)
