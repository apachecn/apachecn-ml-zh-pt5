<title>Using Features and Reinforcement Learning to Automate Bank Financing</title>  Using Features and Reinforcement Learning to Automate Bank Financing
...
巴塞尔委员会评估并实施全球银行风险管理法规。根据巴塞尔委员会(【https://www.bis.org/bcbs/qis/qis3qa_f.htm】)对违约*t/损失*的*定义，信用评级预测借款人(被评级的人)在一年内破产的概率。由于公司破产，借款人通常会拖欠贷款。所以，我们通常交替使用违约和破产。*
